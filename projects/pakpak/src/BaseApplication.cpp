  ...
  if (mRoot->showConfigDialog())
    {
      ...
      // passing 'true'.
      mWindow = mRoot->initialise(true, "Pak Pak");
  ...
  if (!mTrayMgr->isDialogVisible())
    {
      ...
      if (mDetailsPanel->isVisible()) // If details panel is visible, then
                                      // update its contents
	{
	  ...
	  mDetailsPanel->setParamValue(
	      4, Ogre::StringConverter::toString(
	             mCamera->getDerivedOrientation().w));
	  mDetailsPanel->setParamValue(
	      5, Ogre::StringConverter::toString(
	             mCamera->getDerivedOrientation().x));
	  mDetailsPanel->setParamValue(
	      6, Ogre::StringConverter::toString(
	             mCamera->getDerivedOrientation().y));
	  mDetailsPanel->setParamValue(
	      7, Ogre::StringConverter::toString(
