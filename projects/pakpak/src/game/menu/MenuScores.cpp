...
namespace core
{
  ...
  void MenuScores::entry()
  {
    ...
    static_cast<CEGUI::ItemListbox *>(m_gui.getRoot()->getChild("list_best_times"))
        ->setAutoResizeEnabled(1);
    static_cast<CEGUI::ItemListbox *>(m_gui.getRoot()->getChild("list_finished_tracks"))
        ->setAutoResizeEnabled(1);
    static_cast<CEGUI::ItemListbox *>(m_gui.getRoot()->getChild("list_max_speed"))
        ->setAutoResizeEnabled(1);
    static_cast<CEGUI::ItemListbox *>(m_gui.getRoot()->getChild("list_collision_count"))
        ->setAutoResizeEnabled(1);
    static_cast<CEGUI::ItemListbox *>(m_gui.getRoot()->getChild("list_total_km"))
        ->setAutoResizeEnabled(1);
    static_cast<CEGUI::ItemListbox *>(m_gui.getRoot()->getChild("list_best_times"))
        ->disable();
    static_cast<CEGUI::ItemListbox *>(m_gui.getRoot()->getChild("list_finished_tracks"))
    ...
    for (std::int32_t i = 0; i < 10; ++i)
      {
	CEGUI::ItemEntry *itm = static_cast<CEGUI::ItemEntry *>(winManager->createWindow(
	    "TaharezLook/ListboxItem"));
	CEGUI::ItemEntry *itm2 = static_cast<CEGUI::ItemEntry *>(winManager->createWindow(
	    "TaharezLook/ListboxItem"));
	CEGUI::ItemEntry *itm3 = static_cast<CEGUI::ItemEntry *>(winManager->createWindow(
	    "TaharezLook/ListboxItem"));
	CEGUI::ItemEntry *itm4 = static_cast<CEGUI::ItemEntry *>(winManager->createWindow(
	    "TaharezLook/ListboxItem"));
	CEGUI::ItemEntry *itm5 = static_cast<CEGUI::ItemEntry *>(winManager->createWindow(
	    "TaharezLook/ListboxItem"));
	...
	static_cast<CEGUI::ItemListbox *>(m_gui.getRoot()->getChild("list_best_times"))
	    ->addItem(itm);
	static_cast<CEGUI::ItemListbox *>(m_gui.getRoot()->getChild(
